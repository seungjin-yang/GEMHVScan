...
# with command line options: UndergroundCosmicMu_cfi --era Run3 --conditions auto:phase1_2021_cosmics --geometry DB:Extended --scenario cosmics --beamspot Run3RoundOptics25ns13TeVLowSigmaZ --step GEN,SIM --datatier GEN-SIM --eventcontent FEVTDEBUG --fileout file:step1.root --number 10 --relval 9000,50
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('UndergroundCosmicMu_cfi nevts:10'),
