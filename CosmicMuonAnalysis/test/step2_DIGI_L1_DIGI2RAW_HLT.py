...
# with command line options: step2 --era Run3 --conditions auto:phase1_2021_cosmics --geometry DB:Extended --scenario cosmics --step DIGI:pdigi_valid,L1,DIGI2RAW,HLT:@relval2021 --datatier GEN-SIM-DIGI-RAW --eventcontent FEVTDEBUG --filein file:step1.root --fileout file:step2.root --number -1
